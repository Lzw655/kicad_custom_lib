...
class CopperThiefDlg(Dialog):
    ...
    def __init__(self, parent):
        Dialog.__init__(self, parent, id=ID_ANY, title=u"Copper Thief Parameters", pos=DefaultPosition, size=Size(300, 300), style=CAPTION | CLOSE_BOX | DEFAULT_DIALOG_STYLE | RESIZE_BORDER)
        ...
        self.m_spacing.SetMinSize(Size(100, -1))
        ...
        self.m_radius.SetMinSize(Size(100, -1))
