...
class MyFrame(wx.Frame):
    ...
    def __init__(self, parent):
        wx.Frame.__init__(self, parent, id = wx.ID_ANY, title = "Spiral Plugin", pos = wx.DefaultPosition, size = wx.Size( 500,500 ), style = wx.CAPTION|wx.CLOSE_BOX|wx.TAB_TRAVERSAL)
