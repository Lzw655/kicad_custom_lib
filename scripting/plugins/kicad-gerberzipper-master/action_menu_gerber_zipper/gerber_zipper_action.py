        ...
        class Dialog(wx.Dialog):
            def __init__(self, parent):
                ...
                for fname in manufacturers_list:
                    try:
                        self.json_data.append(json.load(open(fname, 'r', encoding='utf-8')))
                ...
                InitEm()
                wx.Dialog.__init__(self, parent, id=-1, title='Gerber-Zipper '+version, size=Em(66,13),
                ...
                self.detailbtn = wx.ToggleButton(self.panel, wx.ID_ANY, getstr('DETAIL'),size=Em(20,2),pos=Em(2,8.5))
                self.execbtn = wx.Button(self.panel, wx.ID_ANY, getstr('EXEC'),size=Em(20,2),pos=Em(22,8.5))
                self.clsbtn = wx.Button(self.panel, wx.ID_ANY, getstr('CLOSE'),size=Em(20,2),pos=Em(42,8.5))
